...
DEFAULT_WRITE_SLEEP_S = 0.2 # updated for Huawei inverters; originally value 0.05
DEFAULT_READ_SLEEP_S = 0.2 # updated for Huawei inverters; originally value 0.05
